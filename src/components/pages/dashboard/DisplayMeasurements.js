    ...
    return (
        <React.Fragment>
            <div style={{ color: 'white', textAlign: 'center', width: '80%', margin: 'auto', marginTop: '30px', padding: '0' }}>
                <InputGroup className="mb-3 searchInputGroup">
                    ...
                    <FormControl
                        ...
                        onChange={(e) => props.filterMeasurements(e.target.value)}
                    />
                </InputGroup>
            </div>
            <div className="measurementsWrapper">
                        ...
                        <div className="measurementDataWrapper" key={item.measurement_id}>
                            ...
                            <InputGroup className="mb-3">
                                ...
                                >
                                    ...
                                    <InputGroup.Text style={{ fontWeight: '700', justifyContent: 'center' }} disabled={true}>
                                        cm
                                    </InputGroup.Text>
                            ...
                            <div
                                ...
                                style={{ display: 'flex', gap: '10px', marginTop: '10px', justifyContent: 'space-evenly' }}
                            >
                                <Button
                                    onClick={() => {
                ...
                {props.measurements.length === 0 ? <h1 style={{ color: 'white', marginTop: '50px', textAlign: 'center' }}>No measurements</h1> : ''}
            </div>
        </React.Fragment>
    )
}
